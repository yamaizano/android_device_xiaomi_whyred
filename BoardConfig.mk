...
DEVICE_SPECIFIC_AUDIO_PATH := hardware/qcom-caf/sdm660/audio
...
DEVICE_SPECIFIC_DISPLAY_PATH := hardware/qcom-caf/sdm660/display
...
DEVICE_SPECIFIC_MEDIA_PATH := hardware/qcom-caf/sdm660/media
...
ifneq ($(or $(WITH_GMS), $(WITH_GAPPS)),true)
$(foreach p, $(call to-upper, $(SSI_PARTITIONS)), \
    $(eval BOARD_$(p)IMAGE_EXTFS_INODE_COUNT := -1))
BOARD_SYSTEMIMAGE_PARTITION_RESERVED_SIZE := 94371840     # 90 MB
BOARD_SYSTEM_EXTIMAGE_PARTITION_RESERVED_SIZE := 94371840 # 90 MB
BOARD_PRODUCTIMAGE_PARTITION_RESERVED_SIZE := 2899479104  # 2765 MB (412MB free)
else
